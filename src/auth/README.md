...
Los middlewares de sesión/rol (`withAuth`/`withRole`, BE-035/BE-036, Fase 3)
viven en [`src/middlewares/`](../middlewares/README.md) — reemplazan al
helper provisorio que antes vivía acá (`session.ts`).
