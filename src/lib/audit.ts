...
export type AuditAction =
  ...
  | "CONTRACT_UPDATED"
  | "CONTRACT_DELETED"
  | "CONTRACT_BORROWER_ADDED"
  | "CONTRACT_BORROWER_REMOVED"
  | "CONTRACT_TERMS_PROPOSED"
  | "CONTRACT_TERMS_SUBMITTED"
  | "CONTRACT_TERMS_ACCEPTED"
  | "CONTRACT_TERMS_REJECTED"
  | "CONTRACT_FEE_ITEM_ADDED"
  | "CONTRACT_FEE_ITEM_REMOVED"
  | "CONTRACT_ACTIVATED"
  | "CONTRACT_CANCELLED"
  | "CONTRACT_MARKED_DELINQUENT"
  | "CONTRACT_DELINQUENCY_RESOLVED"
  | "LATE_FEE_ASSESSED"
  // Marketplace (Fase 13)
  | "LOAN_REQUEST_CREATED"
  | "LOAN_REQUEST_UPDATED"
  | "LOAN_REQUEST_PUBLISHED"
  | "LOAN_REQUEST_WITHDRAWN"
  | "LOAN_REQUEST_TARGET_ADDED"
  | "LOAN_REQUEST_TARGET_REMOVED"
  | "LOAN_QUOTE_SUBMITTED"
  | "LOAN_QUOTE_WITHDRAWN"
  | "LOAN_QUOTE_SELECTED"
  // Pagos
  | "TRANSACTION_CREATED"
