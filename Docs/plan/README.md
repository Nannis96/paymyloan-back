...
> **Estado**: Plan de trabajo para revisión. No implementado más allá de las Fases 0–5 (ver [IMPLEMENTATION_PROGRESS.md](../IMPLEMENTATION_PROGRESS.md)). No se modificó `schema.prisma`, código ni configuración de Docker como parte de la revisión 2026-09-10 de este documento.
> **Fuentes analizadas**: `paymyloan-alcance.html` v0.1, [PAYMYLOAN_DATABASE_DESIGN.md](../PAYMYLOAN_DATABASE_DESIGN.md), código real de `Owner` (schema.prisma, auth.ts, auth.config.ts), código real de `paymyloan-back` (schema.prisma, src/), las decisiones tomadas explícitamente por el encargo original de este plan (ver [sección 0](00-contradicciones-y-decisiones.md)) y, desde 2026-09-10, [pml_product_spec_v2.pdf](../pml_product_spec_v2.pdf) + [pml_commitment_letter_spec 1.1.pdf](../pml_commitment_letter_spec%201.1.pdf) (ver [00 — Decisiones 2026-09-10](00-contradicciones-y-decisiones.md#decisiones-2026-09-10-ronda-product-spec-v2--commitment-letter-spec)) — esta es la **única fuente de verdad** del plan; [IMPLEMENTATION_PROGRESS.md](../IMPLEMENTATION_PROGRESS.md) es únicamente el checklist de avance sobre este plan, no un documento de diseño paralelo.
...
|---|---|---|
| 0 | [Contradicciones y decisiones de partida](00-contradicciones-y-decisiones.md) | Las 3 contradicciones detectadas (D0-1/2/3), las 5 decisiones de arquitectura (A-1..A-5), y las rondas posteriores por fase (`D-P1-*`..`D-P4-*`, `D-S2-*` para el Product Spec v2/Commitment Letter Spec) |
...
| 4 | [Base de datos](04-base-de-datos.md) | Convenciones, ERD, tablas campo por campo (§4.3 identidad/contratos/pagos, §4.7 marketplace/fees/vetting/notificaciones/ratings), enums, índices y reglas de negocio a nivel de datos |
...
| 15 | [Riesgos y decisiones pendientes](15-riesgos-y-decisiones-pendientes.md) | Los pendientes que pueden cambiar el diseño (10 originales + 9 del 2026-09-04 + 8 del 2026-09-10) |
