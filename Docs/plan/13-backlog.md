...
> **Fase 1 reescrita 2026-09-04**: [fases/fase-01-database.md](fases/fase-01-database.md) quedó superado por el nuevo contexto funcional (roles `BOOKKEEPER`/`INSURANCE_COMPANY`, `LenderCompany`, `Property`). El backlog vigente de Fase 1 es **[16. Fase 1 — plan actualizado](16-fase-1-actualizada.md)**; el resto de las fases (2 en adelante) no se tocó todavía — ver riesgo #18 en [15](15-riesgos-y-decisiones-pendientes.md) sobre su impacto pendiente.
