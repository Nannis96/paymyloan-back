...
>
> **Fase 3 implementada 2026-09-08** tal cual [fases/fase-03-authorization.md](fases/fase-03-authorization.md) especifica, **salvo `BE-037`** (`withTenantScope`): diferido a Fase 4 por falta de un endpoint consumidor real (`D-P3-2`, ver [00](00-contradicciones-y-decisiones.md#decisiones-2026-09-08-ronda-fase-3) y riesgo #18 en [15](15-riesgos-y-decisiones-pendientes.md)). `BE-036` (`withRole`) además acota el alcance de la regla de 2FA obligatorio de §7.4 a endpoints de negocio, no autoservicio (`D-P3-1`).
>
> **Fase 4/5 implementadas 2026-09-08** contra el schema real (`D-P1-3`/`D-P1-4`) — [fases/fase-04-admin-lenders.md](fases/fase-04-admin-lenders.md) y [fases/fase-05-borrowers.md](fases/fase-05-borrowers.md) hablaban de `BorrowerProfile.lenderId`, que ya no existe. Resuelven el acceso multi-empresa sin construir `withTenantScope` (`D-P4-1`, sigue diferido a Fase 6) y agregan `User.mustChangePassword` (`D-P4-2`) + el ticket nuevo `BE-100` (`GET`/`PATCH /api/lenders/me`, `D-P4-3`). Detalle completo en [00](00-contradicciones-y-decisiones.md#decisiones-2026-09-08-ronda-fase-45).
>
