...
| `Property` (60+ campos de marketing) | Parcial | ADAPT — el `Property` de 60+ campos de marketing (bilingüe, SEO, showings, comisión de agente) se descarta, pero desde el 2026-09-04 (`D-P1-5`, revierte `A-4`) sí existe una tabla `Property` propia en PayMyLoan: dirección + campos mínimos de ARV/valuation/taxes tomados de la lógica de `app/api/analyze/route.ts` de Owner — ver [04](04-base-de-datos.md#property-nueva) |
